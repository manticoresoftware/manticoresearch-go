...
❗ WARNING: this is a development version of the client. The latest release's readme is https://github.com/manticoresoftware/manticoresearch-go/tree/v1.13.0
...
| v1.13.0 or newer           | 28.6.6 or newer                     | 1.17.0 or newer   | ✅ Fully Compatible       |
| v1.13.0 or newer           | 17.5.1 to 28.6.6                    | 1.17.0 or newer   | ⚠️ Partially Compatible  |
| v1.11.0 to v1.13.0         | 28.6.6 or newer                     | 1.17.0 or newer   | ⚠️ Partially Compatible  |
| v1.11.0 to v1.13.0         | 17.5.1 to 28.6.6                    | 1.17.0 or newer   | ✅ Fully Compatible       |
| v1.9.0 to v1.11.0          | 17.5.1 to 28.6.6                    | 1.17.0 or newer   | ⚠️ Partially Compatible  |
