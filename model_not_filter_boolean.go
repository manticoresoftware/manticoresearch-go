...
// checks if the NotFilterBoolean type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotFilterBoolean{}
...
type _NotFilterBoolean NotFilterBoolean
...
func (o *NotFilterBoolean) UnmarshalJSON(data []byte) (err error) {
	...
	varNotFilterBoolean := _NotFilterBoolean{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varNotFilterBoolean)

	if err != nil {
		return err
	}

	*o = NotFilterBoolean(varNotFilterBoolean)

	return err
}

type NullableNotFilterBoolean struct {
	value *NotFilterBoolean
	isSet bool
}

func (v NullableNotFilterBoolean) Get() *NotFilterBoolean {
	return v.value
}

func (v *NullableNotFilterBoolean) Set(val *NotFilterBoolean) {
	v.value = val
	v.isSet = true
}
...
func NewNullableNotFilterBoolean(val *NotFilterBoolean) *NullableNotFilterBoolean {
	return &NullableNotFilterBoolean{value: val, isSet: true}
}
