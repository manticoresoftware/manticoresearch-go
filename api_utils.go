...
func (r ApiTokenRequest) Body(body map[string]interface{}) ApiTokenRequest {
	r.body = &body
	return r
}

func (r ApiTokenRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.TokenExecute(r)
}

/*
Token Create or rotate a bearer token
...
*/
func (a *UtilsAPIService) Token(ctx context.Context) ApiTokenRequest {
	return ApiTokenRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return string
func (a *UtilsAPIService) TokenExecute(r ApiTokenRequest) (string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UtilsAPIService.Token")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
