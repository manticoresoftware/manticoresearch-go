...
/*
Delete Delete a document in a table
...
/*
Insert Create a new document in a table
...
/*
PartialReplace Partially replaces a document in a table
...
func (a *IndexAPIService) PartialReplaceExecute(r ApiPartialReplaceRequest) (*UpdateResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/{table}/_update/{id}"
...
type ApiPartialReplaceUuidRequest struct {
	ctx context.Context
	ApiService *IndexAPIService
	table string
	uuid string
...
func (r ApiPartialReplaceUuidRequest) ReplaceDocumentRequest(replaceDocumentRequest ReplaceDocumentRequest) ApiPartialReplaceUuidRequest {
	r.replaceDocumentRequest = &replaceDocumentRequest
	return r
}

func (r ApiPartialReplaceUuidRequest) Execute() (*UpdateResponse, *http.Response, error) {
	return r.ApiService.PartialReplaceUuidExecute(r)
}

// PartialReplaceUuid Partially replaces a document in a table by UUID
func (a *IndexAPIService) PartialReplaceUuid(ctx context.Context, table string, uuid string) ApiPartialReplaceUuidRequest {
	return ApiPartialReplaceUuidRequest{
		ApiService: a,
		ctx: ctx,
		table: table,
		uuid: uuid,
...
func (a *IndexAPIService) PartialReplaceUuidExecute(r ApiPartialReplaceUuidRequest) (*UpdateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IndexAPIService.PartialReplaceUuid")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarPath := localBasePath + "/{table}/_update/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"table"+"}", url.PathEscape(parameterValueToString(r.table, "table")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.uuid, "id")), -1)
...
/*
Replace Replace new document in a table
...
/*
Update Update a document in a table
